...
# ✅ 본문 영역의 큰 제목은 제거 (세로 공간 아끼기)
# (예전의 st.markdown("### 🔍 YouTube검색기") 삭제)
...
# 트렌드 검색 시 카테고리 선택 (랜덤 트렌드는 랜덤으로 고름)
